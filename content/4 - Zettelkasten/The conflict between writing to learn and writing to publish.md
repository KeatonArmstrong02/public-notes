...
# The conflict between writing to learn and writing to publish
...
The skill encapsulates two separate interests of a writer.
1). If they are motivated intrinsically to the call of writing, then 
2). wanting to turn it into a living.
